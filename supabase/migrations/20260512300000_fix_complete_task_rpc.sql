-- Re-apply complete_task RPC with inline XP/coin updates.
-- The previous version on remote called award_points() which rejects child users.
-- This version does all updates inline within SECURITY DEFINER context.
...
begin
  ...
  -- 2. Award points (inline, no award_points() call)
