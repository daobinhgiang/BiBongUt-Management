-- Fix: complete_task should NOT create recurring next-day tasks for daily_habit tasks.
-- ensure_daily_habits already handles seeding daily habits each day.
...
begin
  ...
  --    Daily habits are seeded by ensure_daily_habits on app open, so skip here.
